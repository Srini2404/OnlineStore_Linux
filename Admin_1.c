...
int main(int argc,char*argv[])
{
        ...
        while(1)
        {
            ...
            if(!fork())
            {
                while (1){
                    ...
                    {        
                        // printf("Yo\n");
                        int fd3 = open(argv[4],O_TRUNC|O_RDWR|O_CREAT,0777);
                        int orderid;
    ...
    {
        int option;
        printf("The menu for server side data updation \n");
        printf("---------------------------------------------------------------------------------\n");
        ...
        printf("Enter 5 to exit and record the changes in the log file\n");
        ...
        while(1)
        {
            ...
            { 
                ...
                int fd3;
                fd3 = open(argv[3],O_TRUNC| O_RDWR | O_CREAT, 0777); // this is the log file that is generated.
